...
export default function Location() {
  ...
  return (
    <section
      className="space-y-8"
      style={{ backgroundColor: "#2B7FFF", minHeight: "100vh", padding: "2rem 0" }}
    >
      <div
        className="relative overflow-hidden rounded-3xl border border-[#50A2FF]/30 p-8"
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div
          className="relative overflow-hidden rounded-3xl border border-white/20 p-8"
          style={{ backgroundColor: "#BBF451" }}
        >
